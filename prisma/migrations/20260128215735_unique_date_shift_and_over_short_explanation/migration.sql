...
INSERT INTO "new_shift_close" ("count_cash", "count_checks", "count_credit", "count_fleet", "count_inhouse", "count_massy_coupons", "created_at", "date", "debit_scan_urls", "deposit_scan_urls", "deposits", "diesel", "has_missing_hard_copy_data", "id", "missing_data_notes", "notes", "other_credit", "over_short_cash", "over_short_explained", "over_short_total", "shift", "status", "supervisor", "system_cash", "system_checks", "system_credit", "system_debit", "system_fleet", "system_inhouse", "system_massy_coupons", "total_deposits", "unleaded") SELECT "count_cash", "count_checks", "count_credit", "count_fleet", "count_inhouse", "count_massy_coupons", "created_at", "date", "debit_scan_urls", "deposit_scan_urls", "deposits", "diesel", "has_missing_hard_copy_data", "id", "missing_data_notes", "notes", "other_credit", "over_short_cash", "over_short_explained", "over_short_total", "shift", "status", "supervisor", "system_cash", "system_checks", "system_credit", "system_debit", "system_fleet", "system_inhouse", "system_massy_coupons", "total_deposits", "unleaded" FROM "shift_close";
