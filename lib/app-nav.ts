...
const BASE_NAV_CONFIG: NavGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Payroll', href: '/payroll', permission: 'people.staff' },
...
const HREF_SHORTCUT_OVERRIDES: Record<string, HomeShortcutId> = {
  ...
  '/settings/inbox-mailboxes': 'settings-inbox-mailboxes',
...
export function isPathActive(pathname: string, href: string): boolean {
  ...
  if (href === '/settings/inbox-mailboxes') return pathname.startsWith('/settings/inbox-mailboxes')
