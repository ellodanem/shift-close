...
export async function GET() {
  try {
    ...
    console.error('attendance end-of-day-email GET', e)
 ...
 * Or send test: { sendTest: true, recipients?, timeZone? } — recipients/timeZone in the body use the
 * current form values so a test send works before Save; omitted fields fall back to stored settings.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('attendance end-of-day-email POST', e)
